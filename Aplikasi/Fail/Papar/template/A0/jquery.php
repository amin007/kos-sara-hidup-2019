...
// kod jquery global
	...
	{
		$('.cleditor').cleditor();/* ---------- Text editor ---------- */
		$('.date-picker').datepicker();/* ---------- Datapicker ---------- */
		$('[data-rel="chosen"],[rel="chosen"]').chosen();/* ---------- Choosen ---------- */
		$('input, textarea').placeholder();/* ---------- Placeholder Fix for IE ---------- */
		$('textarea').autosize();/* ---------- Auto Height texarea ---------- */
		...
		$('#timepicker1').timepicker();/* ---------- Timepicker for Bootstrap ---------- */
		$('#daterange').daterangepicker();/* ---------- DateRangepicker for Bootstrap ---------- */
		$('.editor').wysiwyg();/* ---------- Bootstrap Wysiwig ---------- */
		$('#colorpicker1').colorpicker();/* ---------- Colorpicker for Bootstrap ---------- */
	});
</script>
<style type="text/css">
	.suggestionsBox
...
<script>
	...
	var barChartData = {
		labels: ["BEK", "ICT", "SIH", "WANG", "BUAT", "DIDIK", "LORI", "HOTEL", "LAIN", "PRO"],
		datasets: [
				{
